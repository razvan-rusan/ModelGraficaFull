...
namespace ModelGraficaFull
{
    public static class LSystems
    {
        ...
        : LSystem(g, axiom, angle, pos, segmentLength, numIterations)
        {
            ...
            {
                PointF disp = new PointF(MathF.Cos(currentAngle) * this.segmentLength,
                             MathF.Sin(currentAngle) * this.segmentLength);
        ...
        public class Weed(Graphics g, string axiom, float angle, PointF pos, float segmentLength, int numIterations)
            : LSystem(g, axiom, angle, pos, segmentLength, numIterations)
        {
            public override void Draw()
            {
